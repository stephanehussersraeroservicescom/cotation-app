...
<div class="min-h-full">
            ...
            <div class="flex h-16 items-center justify-between">
                <div class="flex items-center">
                    <div class="flex-shrink-0">
                        <img class="h-8 w-18" src="https://www.tapiscorp.com/wp-content/uploads/2020/10/tapis-logo.png" alt="Your Company">
                    </div>
                    <div class="hidden md:block">
                        <div class="ml-10 flex items-baseline space-x-4">
                            <x-nav-link href="/" :active="request()->is('/')" >Home</x-nav-link>
                            <x-nav-link href="/quotes" :active="request()->is('quotes.index')" >My Quotes</x-nav-link>
                            <x-nav-link href="/quote/form" :active="request()->is('quote.form')" >New Quote</x-nav-link>
                        </div>
                    </div>
                </div>
    ...
    <header class="bg-white shadow">
        <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
            <h1 class="text-3xl font-bold tracking-tight text-gray-900">Titre</h1>
        </div>
    </header>
